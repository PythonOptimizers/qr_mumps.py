...
try:
    from qr_mumps import version as __version__
    # The short X.Y version.
    version = '.'.join(__version__.version.split('.')[:2])
...
latex_documents = [
  ('contents', 'user_manual.tex', ur"qr\_mumps.py's users manual",
   ur'Sylvain Arreckx\\Dominique Orban\\Nikolaj van Omme', 'manual'),
]
