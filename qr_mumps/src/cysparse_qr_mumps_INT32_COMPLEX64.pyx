...
from qr_mumps.src.qr_mumps_INT32_COMPLEX64 cimport BaseQRMUMPSSolver_INT32_COMPLEX64, c_to_fortran_index_array
...
cdef class CySparseQRMUMPSSolver_INT32_COMPLEX64(BaseQRMUMPSSolver_INT32_COMPLEX64):
    ...
    cpdef get_matrix_data(self, LLSparseMatrix_INT32_t_COMPLEX64_t A):
        ...
        a_val = <COMPLEX64_t *> PyMem_Malloc(self.nnz * sizeof(COMPLEX64_t))
        A.fill_triplet(self.params.irn, self.params.jcn, a_val)
        self.params.val = <float complex *> a_val
