...
base_ext_params_INT32_COMPLEX64['include_dirs'].extend(qr_mumps_include_dirs)
base_ext_params_INT32_COMPLEX64['library_dirs'] = qr_mumps_library_dirs
base_ext_params_INT32_COMPLEX64['libraries'] = [] # 'scalapack', 'pord']
base_ext_params_INT32_COMPLEX64['libraries'].append('cqrm')
base_ext_params_INT32_COMPLEX64['libraries'].append('qrm_common')
qr_mumps_ext.append(Extension(name="qr_mumps.src.qr_mumps_INT32_COMPLEX64",
                sources=['qr_mumps/src/qr_mumps_INT32_COMPLEX64.pxd',
                'qr_mumps/src/qr_mumps_INT32_COMPLEX64.pyx'],
                **base_ext_params_INT32_COMPLEX64))

numpy_ext_params_INT32_COMPLEX64 = copy.deepcopy(ext_params)
numpy_ext_params_INT32_COMPLEX64['include_dirs'].extend(qr_mumps_include_dirs)
qr_mumps_ext.append(Extension(name="qr_mumps.src.numpy_qr_mumps_INT32_COMPLEX64",
                 sources=['qr_mumps/src/numpy_qr_mumps_INT32_COMPLEX64.pxd',
                 'qr_mumps/src/numpy_qr_mumps_INT32_COMPLEX64.pyx'],
                 **numpy_ext_params_INT32_COMPLEX64))

base_ext_params_INT32_COMPLEX128 = copy.deepcopy(ext_params)
base_ext_params_INT32_COMPLEX128['include_dirs'].extend(qr_mumps_include_dirs)
base_ext_params_INT32_COMPLEX128['library_dirs'] = qr_mumps_library_dirs
base_ext_params_INT32_COMPLEX128['libraries'] = [] # 'scalapack', 'pord']
base_ext_params_INT32_COMPLEX128['libraries'].append('zqrm')
base_ext_params_INT32_COMPLEX128['libraries'].append('qrm_common')
qr_mumps_ext.append(Extension(name="qr_mumps.src.qr_mumps_INT32_COMPLEX128",
                sources=['qr_mumps/src/qr_mumps_INT32_COMPLEX128.pxd',
                'qr_mumps/src/qr_mumps_INT32_COMPLEX128.pyx'],
                **base_ext_params_INT32_COMPLEX128))

numpy_ext_params_INT32_COMPLEX128 = copy.deepcopy(ext_params)
numpy_ext_params_INT32_COMPLEX128['include_dirs'].extend(qr_mumps_include_dirs)
qr_mumps_ext.append(Extension(name="qr_mumps.src.numpy_qr_mumps_INT32_COMPLEX128",
                 sources=['qr_mumps/src/numpy_qr_mumps_INT32_COMPLEX128.pxd',
                 'qr_mumps/src/numpy_qr_mumps_INT32_COMPLEX128.pyx'],
                 **numpy_ext_params_INT32_COMPLEX128))

base_ext_params_INT32_FLOAT32 = copy.deepcopy(ext_params)
base_ext_params_INT32_FLOAT32['include_dirs'].extend(qr_mumps_include_dirs)
base_ext_params_INT32_FLOAT32['library_dirs'] = qr_mumps_library_dirs
base_ext_params_INT32_FLOAT32['libraries'] = [] # 'scalapack', 'pord']
base_ext_params_INT32_FLOAT32['libraries'].append('sqrm')
base_ext_params_INT32_FLOAT32['libraries'].append('qrm_common')
qr_mumps_ext.append(Extension(name="qr_mumps.src.qr_mumps_INT32_FLOAT32",
                sources=['qr_mumps/src/qr_mumps_INT32_FLOAT32.pxd',
                'qr_mumps/src/qr_mumps_INT32_FLOAT32.pyx'],
                **base_ext_params_INT32_FLOAT32))

numpy_ext_params_INT32_FLOAT32 = copy.deepcopy(ext_params)
numpy_ext_params_INT32_FLOAT32['include_dirs'].extend(qr_mumps_include_dirs)
qr_mumps_ext.append(Extension(name="qr_mumps.src.numpy_qr_mumps_INT32_FLOAT32",
                 sources=['qr_mumps/src/numpy_qr_mumps_INT32_FLOAT32.pxd',
                 'qr_mumps/src/numpy_qr_mumps_INT32_FLOAT32.pyx'],
                 **numpy_ext_params_INT32_FLOAT32))

base_ext_params_INT32_FLOAT64 = copy.deepcopy(ext_params)
base_ext_params_INT32_FLOAT64['include_dirs'].extend(qr_mumps_include_dirs)
base_ext_params_INT32_FLOAT64['library_dirs'] = qr_mumps_library_dirs
base_ext_params_INT32_FLOAT64['libraries'] = [] # 'scalapack', 'pord']
base_ext_params_INT32_FLOAT64['libraries'].append('dqrm')
base_ext_params_INT32_FLOAT64['libraries'].append('qrm_common')
qr_mumps_ext.append(Extension(name="qr_mumps.src.qr_mumps_INT32_FLOAT64",
                sources=['qr_mumps/src/qr_mumps_INT32_FLOAT64.pxd',
                'qr_mumps/src/qr_mumps_INT32_FLOAT64.pyx'],
                **base_ext_params_INT32_FLOAT64))

numpy_ext_params_INT32_FLOAT64 = copy.deepcopy(ext_params)
numpy_ext_params_INT32_FLOAT64['include_dirs'].extend(qr_mumps_include_dirs)
qr_mumps_ext.append(Extension(name="qr_mumps.src.numpy_qr_mumps_INT32_FLOAT64",
                 sources=['qr_mumps/src/numpy_qr_mumps_INT32_FLOAT64.pxd',
                 'qr_mumps/src/numpy_qr_mumps_INT32_FLOAT64.pyx'],
...
if build_cysparse_ext:
    ...
    cysparse_ext_params_INT32_COMPLEX64['include_dirs'].extend(qr_mumps_include_dirs)
    qr_mumps_ext.append(Extension(name="qr_mumps.src.cysparse_qr_mumps_INT32_COMPLEX64",
                 sources=['qr_mumps/src/cysparse_qr_mumps_INT32_COMPLEX64.pxd',
                 'qr_mumps/src/cysparse_qr_mumps_INT32_COMPLEX64.pyx'],
    ...
    cysparse_ext_params_INT32_COMPLEX128['include_dirs'].extend(qr_mumps_include_dirs)
    qr_mumps_ext.append(Extension(name="qr_mumps.src.cysparse_qr_mumps_INT32_COMPLEX128",
                 sources=['qr_mumps/src/cysparse_qr_mumps_INT32_COMPLEX128.pxd',
                 'qr_mumps/src/cysparse_qr_mumps_INT32_COMPLEX128.pyx'],
    ...
    cysparse_ext_params_INT32_FLOAT32['include_dirs'].extend(qr_mumps_include_dirs)
    qr_mumps_ext.append(Extension(name="qr_mumps.src.cysparse_qr_mumps_INT32_FLOAT32",
                 sources=['qr_mumps/src/cysparse_qr_mumps_INT32_FLOAT32.pxd',
                 'qr_mumps/src/cysparse_qr_mumps_INT32_FLOAT32.pyx'],
    ...
    cysparse_ext_params_INT32_FLOAT64['include_dirs'].extend(qr_mumps_include_dirs)
    qr_mumps_ext.append(Extension(name="qr_mumps.src.cysparse_qr_mumps_INT32_FLOAT64",
                 sources=['qr_mumps/src/cysparse_qr_mumps_INT32_FLOAT64.pxd',
                 'qr_mumps/src/cysparse_qr_mumps_INT32_FLOAT64.pyx'],
